        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 mt-6 overflow-x-auto">
            <div className="min-w-210">
              <div className="grid grid-cols-[minmax(230px,1.6fr)_minmax(160px,1fr)_minmax(180px,1fr)_130px_120px] gap-x-4 bg-[#F8FAFC] px-4 py-3 text-sm font-semibold text-slate-700">
                <p>Product ID</p>
                <p>Title</p>
                <p>Vendor</p>
                <p>Featured</p>
              ...
              {products.map((product) => (
                <div
                  key={product._id}
                  className="grid grid-cols-[minmax(230px,1.6fr)_minmax(160px,1fr)_minmax(180px,1fr)_130px_120px] gap-x-4 px-4 py-3 text-sm border-t border-slate-200 text-slate-700"
                >
