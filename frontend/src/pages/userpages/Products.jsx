        ...
        <div className="flex flex-col gap-6 md:w-full">
          <div className="flex md:flex-row flex-col gap-3 ">
            <div className="relative w-full">
              <IoMdSearch className="absolute top-1/2 -translate-y-1/2 left-3 text-xl text-gray-400" />
              <input
                className="bg-white outline-0 border pl-10 w-full border-gray-200 p-2 rounded-xl md:h-10"
                type="text"
                value={search}
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            {products.length == 0 ? (
              <div className="w-full font-semibold h-86 flex justify-center items-center text-center">
